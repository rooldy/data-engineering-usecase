"""
=========================================
LOAD Panier - BRONZE LAYER
=========================================
Ce script charge la table Panier depuis la couche RAW (CSV)
...
# CONSTANTES
# =========================
TABLE_NAME = "fact_panier"  # correspond au dossier RAW/fact_panier

# =========================
# FONCTION DE CHARGEMENT
# =========================
def load_panier() -> None:
    """
    Charge les données panier depuis la couche RAW vers la couche BRONZE.
    - Source : CSV
    - Destination : Parquet
    """

    spark = get_spark_session("bronze_load_panier")
